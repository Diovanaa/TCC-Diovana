        ...
        <div class="row display-table-row ">
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                      <div class="col-lg-7">
                        <form action="<?=site_url('Doacoes/Salvar')?>" method="post">
                              <!-- Entrada nome doador-->
                              ...
                              <div class="form-group col-lg-6">
                                  <label for="tipoDoacao">Tipo de Doação*:</label>
                                       <select class="form-control" name="doacao_tipo" id="tipoDoacao">
                              ...
                              <div class="form-group col-lg-6">
                                   ...
                                   <input type="date" id="dataDoacao" name="doacao_data"
                              ...
                              <div class="form-group col-lg-6">
                                   ...
                                   <input type="date" id="ultimaDoacao" name="doacao_ultima_doacao" placeholder="Data da ultima doação"
                                   value="" class="form-control" required  />
                              </div>
