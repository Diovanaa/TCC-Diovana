...
<title>Cadastro de novo usuário - HemoUnião</title>
...
<a class="navbar-brand" href="/your.groupid/;jsessionid=B3492B48A59F9AF78373ADB67BDBC592">HemoUnião</a>
          ...
          <li><a data-toggle="modal" href="<?=site_url('login')?>" onclick="openLoginModal();">
              ...
              <li><a data-toggle="modal" href="<?=site_url('cadastro')?>">
				...
				<div class="tab-content">
					...
					<div id="entidade" class="tab-pane fade">
						...
						<form action="<?=site_url('doador/logindoador')?>" method="post">
							...
							<div class="form-group">
								<label for="loginDoador">Email</label>
								<input type="text"
								id="loginDoador" name="doador_email"
								value="" class="form-control" required />
							</div>
							<div class="form-group">
