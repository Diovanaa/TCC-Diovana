      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
              ...
              <li class="active"><a class="fonte2" href="<?=site_url('Painel_hemocentro/carregaMeuEstoque')?>"><i class="fa fa-plus" aria-hidden="true"></i> Procurar Doadores</a></li>
...
<div id="page-wrapper">
  <div class="row">
    ...
    <div class="col-lg-12">
      <h1 class="page-header">Procurar Doador</h1>
    </div>
    <!-- /.col-lg-12 -->
  </div>
  <!-- /.row -->
