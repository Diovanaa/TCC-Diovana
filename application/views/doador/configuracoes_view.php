          ...
          <div class="panel-heading ">
            <div class="row ">
              <div class="col col-xs-6">
                <h1 class="panel-title">Alterar dados pessoais</h1>
              </div>
              ...
              <div class="table-responsive">
                  ...
                  <tbody>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <select class="form-control" name="doador_sexo" id="sexoDoador">
                              <option value="<?php echo $dadosDoador->sexo ?>"><?php echo $dadosDoador->sexo ?></option>
                ...
                <div class="panel panel-default panel-table">
                  <div class="panel-heading ">
                    <div class="row ">
                      <div class="col col-xs-6">
                        <h1 class="panel-title">Alterar Endereço</h1>
                      </div>
                      <div class="col col-xs-6 text-right">
