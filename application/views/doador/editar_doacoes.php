    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a class="fonte2" href="<?= site_url('painel_doador/carregaMinhasDoacoes') ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Minhas Doações</a></li>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      <select class=" form-control" name="doacao_dia" id="doacao_dia">
                                    ...
                                    <div class="col-md-4 col-lg-4 - col-xs-12">
                                      ...
                                      <select class=" form-control" name="doacao_mes" id="doacao_mes">
                                    ...
                                    <div class="col-md-4 col-lg-4 - col-xs-12">
                                      <select class=" form-control" name="doacao_ano" id="doacao_ano">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="hidden-xs"><b>Data da Ultima Doação</b></td>
                                    <td>
                                <div class="col-md-4 col-lg-4 - col-xs-12">
                                      <select class=" form-control" name="ultima_dia" id="ultima_dia">
                                           <option value="DD">DD</option>
                                           <option value="01">01</option>
                                           <option value="02">02</option>
                                           <option value="03">03</option>
                                    ...
                                    <div class="col-md-4 col-lg-4 - col-xs-12">
                                      ...
                                      <select class=" form-control" name="ultima_mes" id="ultima_mes">
                                    ...
                                    <div class="col-md-4 col-lg-4 - col-xs-12">
                                      <select class=" form-control" name="ultima_ano" id="ultima_ano">
                                           <option value="AAAA">AAAA</option>
                                           <option value="2015">2015</option>
                                           <option value="2014">2014</option>
                                           <option value="2013">2013</option>
