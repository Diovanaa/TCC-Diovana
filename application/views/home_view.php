        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav pull-right " >
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Login <span class="caret"></span></a>
                        ...
                        <div class="form-group ">
                         ...
                         <form class="form" role="form" method="post" action="<?=site_url('doador/logindoador')?>" accept-charset="UTF-8" id="login-nav">
                            <div class="form-group">
                               ...
                               <input type="email" class="form-control" id="emailDoador" name="doador_email" placeholder="Endereço de Email" required>
                            </div>
                            <label for="Senha">Senha:</label>
                            <div class="form-group">
                               <label class="sr-only" for="senhaDoador">Senha</label>
                               <input type="password" class="form-control" id="senhaDoador" name="doador_senha" placeholder="Senha" required>
                             </div>
                            <div class="form-group">
                ...
                <li><a data-toggle="modal" href="<?=site_url('login/loginHemocentro')?>" >
...
<div class="row col-lg-12 diferente ">
  <div class="col-lg-2"></div>
    ...
    <a href="<?=site_url('como_doar/chamandoComoDoar')?>" ><div class="col-lg-3 col-xs-12 diferente2"> <h2 class="diferente"></br></br></br>Como Doar</h2></div></a>


<a href="<?=site_url('cadastro/chamandoCadastroHemocentro')?>" > <div class="col-lg-3 col-xs-12 diferente3"><h2 class="diferente"></br></br></br>Cadastro de Hemocentro</h2></div></a>
...
<div class="row col-lg-12 diferente ">
  <div class="col-lg-2"></div>
    ...
    <a href="<?=site_url('ondedoar/chamandoOndeDoar')?>" > <div class="col-lg-3 col-xs-12 diferente4"><h2 class="diferente"></br></br></br>Onde Doar?</h2></div></a>


    <a href="<?=site_url('como_doar/chamandoComoDoar')?>" >
      <div class="col-lg-3 col-xs-12 diferente5">
