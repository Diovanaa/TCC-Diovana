...
class Hemocentro extends CI_Controller {
	...
	public function salvar_hemocentro() {
		...
		if ($retorno > 0) {
			...
			$this->form_validation->set_rules('hemocentro_email', 'E-mail', 'required|max_length[120]');
			$this->form_validation->set_rules('hemocentro_senha', 'Senha', 'required|max_length[120]');
			$this->form_validation->set_rules('hemocentro_estoque', 'Estoque', 'max_length[120]');
		...
		//	$this->form_validation->set_rules('hemocentro_numero', 'Número', 'required|max_length[120]');
      ...
      $this->form_validation->set_rules('hemocentro_estado', 'Estado', 'required|max_length[120]');
			...
			if ($this->form_validation->run() == FALSE) {
				...
				$this->Hemocentro_model->estoque = $this->input->post('hemocentro_estoque');
			...
			//	$this->Hemocentro_model->numero = $this->input->post('hemocentro_numero');
	...
	public function loginhemocentro() {
		...
		$hemocentro_senha = md5($this->input->post('hemocentro_senha'));
